...
<script>
	import { getDividendsReport, downloadReport } from '@/api/finance';
	import Pagination from '@/components/Pagination';
	export default {
		name: 'DividendsReportList',
		components: {
			Pagination
		},
		filters: {
		...
		methods: {
			getList() {
				...
				getDividendsReport(this.listQuery).then(response => {
