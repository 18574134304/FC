	...
	<div class="app-container">
		<el-card>
			...
			<el-table
				...
				<!--                这里隐藏起来，第二期再开放 -->
				<!--				<el-table-column label="来源订单号/所属用户" align="center">-->
				<!--					<template slot-scope="{row}">-->
				<!--						<span v-if="row.order_info">{{ row.order_info.trade_no }} / {{ row.order_info.user_id }}</span>-->
				<!--					</template>-->
				<!--				</el-table-column>-->
...
<script>
	import { getRewardReport, downloadReport } from '@/api/finance';
	...
	export default {
		...
		methods: {
			getList() {
				...
				getRewardReport(this.listQuery).then(response => {
